...
**总体进度：Iteration 1 完成，Iteration 2 核心功能基本完成**
...
### Iteration 2: Workflow & Enhancement - "核心流程实现与搜索增强" ✅ ~90% 完成
...
- ⏳ 搜索页：预定义 SE Practice 下拉选择（当前为自由输入）
- ⏳ 证据列表与编辑页面
- ⏳ 邮件通知（可选）
...
- **认证页面**: 100% ✅
- **首页**: 100% ✅
- **文章提交**: 100% ✅（含 BibTeX 预填）
- **搜索**: 85% 🚧（已含 Claim/年份/排序/评级展示；Practice 下拉待做）
- **审核员界面**: 100% ✅
  |- **分析师界面**: 100% ✅（含证据录入）
- **管理员界面**: 0% ⏳
- **文章详情**: 100% ✅（含评分）
